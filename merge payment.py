...
# Example usage
source_folder = "./server/payment-service"  # Replace with your source folder if needed
output_file = "merged_payment.txt"  # Replace with your desired output file if needed
